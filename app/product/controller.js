...
const store = async (req, res, next) => {
    try{
        ...
        // update karena relasi dengan categoty
        if(payload.category) {
            let category = 
            await Category
...
// untuk menjalankan fungsi filter category pada insomnia atau postman 
// gunakan perintah GET: localhost:3000/api/products?categories=Food&tags[]=Drink
